...
INSERT INTO `faqs` VALUES (1,'É só acessar a página de cadastro, preencher seus dados e confirmar. Rapidinho, sem burocracia. Por favor não esquça de inserir todos os dados',' Como faço para criar minha conta?'),
(2,'Entre no seu perfil, clique em “Editar” e salve as alterações. Simples e sem mistério.',' Como altero meus dados pessoais?'),
(3,'Nem sempre. Algumas ações precisam que você clique em “Salvar”, então confere antes de sair da página.','O sistema salva automaticamente minhas alterações?'),
(4,'Clique em “Criar playlist”, preencha as informações e confirme. No mesmo formulário é só adicionar suas músicas preferidas.',' Como crio uma playlist?'),
(5,'Com certeza! Abra a playlist, clique em “Editar” e ajeite tudo do jeitinho que quiser.','Posso editar o nome ou a imagem da minha playlist depois?'),
(6,'Dentro da playlist, use o botão “Adicionar música”. Preencha os dados, clique em \"salvar\" e pronto.','Como adiciono músicas a uma playlist?'),
(7,'Provavelmente você criou em outro perfil. Verifica se está no perfil certo — acontece com todo mundo.','Por que minhas playlists não aparecem?'),
(8,'Abra o card da playlist e clique no ícone de lixeira. Confirma a exclusão e ela some do mapa.','Como deleto uma playlist?'),
(9,'Os humores disponíveis aparcerão na hora de criar a playlist ou na seção \"Sugestões\".','Quais humores posso usar?'),
(10,'Pode! No card da playlist tem um botão de favoritar. Depois você vai poder filtrar só as favoritas.','Posso favoritar playlists?'),
(11,'Não! Os emojis já são pré-definidos pelo sistema.','Posso mudar o emoji dos humores?'),
(12,'É necessário ir em configurações e clicar em \"excluir conta\". Mas fique atento, após a exclusão todos os seus dados serão apagados, confira se sua intenção é excluir ou sair da sua conta.','Como excluo minha conta?'),
(13,'Sim! Ele é responsivo, então abre bonitinho no navegador do celular.','O site funciona no celular?'),
(14,'Geralmente é só recarregar a página ou tentar novamente. Se continuar, revisa os campos ou procure o suporte.','Tive um erro ao salvar dados. O que faço?'),
(15,'Entre na playlist, clique no botão “Editar informações” e altere o nome. Salva ali e pronto.','Como edito o nome de uma playlist?'),
(16,'Você só precisa ir na imagem escolhida apertar com o botão direito do mouse (ou pressionar no caso de dispositivo móvel) e copiar o endereço da imagem, depois é só colar no compo indicado.','Como funciona a inserção de imagem no perfil, na playlist e nas músicas?'),
(17,'Sim! No mesmo painel de edição você escolhe outra imagem.','Posso mudar a imagem da playlist?'),
(18,'Abra a playlist, clique em “Editar” e ajuste tudo: descrição, humor, imagem, vibes… é só salvar no final.','Como edito a descrição, humor ou outras informações da playlist?'),
(19,'No card da playlist tem um botão de lixeira. Clicou ali, confirmou… e acabou, ela some do sistema.','Como excluo uma playlist?'),
(20,'Dentro da playlist tem um botão “Adicionar música”. Preenche os campos bonitinho e pronto — tá na lista. Confira sempre se todos os campos estão preenchidos','Como adiciono uma música nova dentro da playlist?'),
(21,'Na lista de músicas da playlist, cada música tem um botão de editar. Ali você pode mudar nome, artista, álbum, duração, gênero, imagem… tudo.','Como edito as informações de uma música?'),
(22,'Do lado do botão de editar tem o botão “excluir”. Clicou, confirmou, música removida sem estresse.','Como excluo uma música da playlist?'),
(23,'Tudo vai junto. As músicas dessa playlist somem com ela.','O que acontece se eu excluir uma playlist com músicas dentro?'),
(24,'Ainda não. Se excluir, já era. Então sempre confirma antes.','Posso desfazer a exclusão?'),
(25,'Vá em Configurações ou Perfil, clique em Editar nome e altere seu nome. Depois é só salvar.','Como edito meu nome no perfil?'),
(26,'Na área de edição de email, troque o e-mail e confirme.','Como altero meu e-mail?'),
(27,'Pode sim! Na parte de Configurações em Alterar senha, você coloca a senha atual e cria uma nova.','Posso mudar minha senha?'),
(28,'Abaixo da sua foto de perfil clique em Editar foto e selecione uma nova imagem. Ao salvar, ela já atualiza.','Como troco minha foto de perfil?'),
(29,'Atualiza a página. Se ainda estiver igual, vê se você clicou Salvar.','Minhas alterações de perfil não aparecem. O que fazer?'),
(30,'Provavelmente já existe uma conta usando esse e-mail, ou ele não passou nas validações. Confere se escreveu certinho.','O sistema não aceita meu novo e-mail. Por quê?');
...
-- Dump completed on 2025-11-24  9:40:31
